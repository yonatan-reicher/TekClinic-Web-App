...
import { Inject, ScheduleComponent, Day, Week, Month, Year,Agenda,ViewsDirective
,ViewDirective} from '@syncfusion/ej2-react-schedule';
import { fetchEndpointResponse, fetchAppointmentList, Appointment,createAppointment, CreateAppointmentRequest,
  deleteAppointment,CreateAppointmentResponse} from "../apiCalls";
...
const MyScheduler = () => {
  ...
  const onPopupOpen = (args :any) => {
    ...
    if (args.type === 'Editor') {
      let statusElement = args.element.querySelector('#ApprovedByPatient');
      if (statusElement) {
  ...
  const onAddButtonClick = (args:any) => {
